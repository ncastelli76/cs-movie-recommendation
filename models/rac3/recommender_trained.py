...
class HybridRecommender:
    ...
    def __init__(self, df, tfidf_matrix, cosine_sim, title_to_idx, prefix):
        self.df = df
    ...
    def recommend_similar_by_id(self, movie_id, top_k=2):
        ...
        while row.empty:
            ...
            #print(row)
            #test=(int(row['id']),row['title'])
            #print(test)
            #listOf=[]
            #return (int(row['id']),row['title'])
